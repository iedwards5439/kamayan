...
public class Serving_01_FixedArraysTest extends TestCase {
    ...
    //     assertThrows(ArrayIndexOutOfBoundsException, () -> { Object x = array[-1]; });
    //     assertThrows(ArrayIndexOutOfBoundsException, () -> { Object x = array[5]; });
    //     assertThrows(ArrayIndexOutOfBoundsException, () -> array[-1] = 1);
    //     assertThrows(ArrayIndexOutOfBoundsException, () -> array[5] = 42);
    // }
}
